...
const IncomeCard = ({ title, amount, comparison, lastWeek, change }) => {
  const isPositive = change >= 0;

  return (
    <div className="bg-white shadow rounded-xl p-5 space-y-2">
      <div className="flex justify-between items-center text-gray-500 text-sm border-b border-gray-300 pb-3">
